...
// Enable dynamic configuration via environment variables on Vercel
// Falls back gracefully to your local settings for XAMPP development
$host = getenv('DB_HOST') ?: '127.0.0.1:8827';
$user = getenv('DB_USER') ?: 'root';
$pass = getenv('DB_PASS') ?: 'paryatan2026';
$db = getenv('DB_NAME') ?: 'ekva_db';
